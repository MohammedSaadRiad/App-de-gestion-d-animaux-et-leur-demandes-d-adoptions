...
import { AnimalService, EntityArrayResponseType } from '../service/animal.service';
...
export class AnimalComponent implements OnInit {
      ...
      .pipe(
        ...
        tap(() => {
          if (this.animals().length === 0) {
            ...
            this.animals.set(this.refineData(this.animals()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.animals.set(this.refineData(dataFromBody));
  }
